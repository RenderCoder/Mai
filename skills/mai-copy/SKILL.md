...
argument-hint: "--product <path> [full-listing|bullets|a-plus|tagline|image-copy] [--length minimal|medium|full]"
---
...
用户可以只用自然语言说“帮我写五点”或“帮我写完整 Listing”。缺少产品资料、文案类型、平台、语言、长度或数量时，按 `workflow.md` 的引导式参数确认一次问一个数字选择题。
